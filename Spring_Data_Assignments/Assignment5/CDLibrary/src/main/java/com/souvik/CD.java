...
@Entity
@Table(name = "CD")
/*@NamedQuery(name = "CD.fetchBycdpriceRange",
query = "SELECT c FROM CD c WHERE cdprice between :price1 and :price2"
)*/
@NamedQuery(name = "CD.fetchByCdPrice",
query = "SELECT c FROM CD c WHERE cdprice > :price1"
)
public class CD {
	@Id
