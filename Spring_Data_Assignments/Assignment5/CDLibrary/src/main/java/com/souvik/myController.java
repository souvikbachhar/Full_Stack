...
/*	@RequestMapping(value = "/findAllSorted1", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/findByCdPrice", method = RequestMethod.GET)
	public @ResponseBody List<CD> findByCdPrice(@RequestParam("price1") float price1) {
		return cdservice.findByCdPrice(price1);
	}
	
	@RequestMapping(value = "/findByCdPriceCount", method = RequestMethod.GET)
	public @ResponseBody int findByCdPriceCount(@RequestParam("price1") float price1) {
		return cdservice.findByCdPrice(price1).size();
	}
